...
function loadApp() {
  ...
  // insights.js (Preços/Mapa/Diagnóstico/Sazonalidade/Visão renderers) and
  // product-detail.js/actions.js (Reposição/Produto/Central de Ações) aren't
  ...
  for (const name of ['renderPrecos', 'renderMapa', 'renderDiagnostico', 'renderSazonalidade', 'renderVisao',
    'renderReposicao', 'renderProdutoDetalhe', 'renderAcoes']) {
    context[name] = () => {};
  }
